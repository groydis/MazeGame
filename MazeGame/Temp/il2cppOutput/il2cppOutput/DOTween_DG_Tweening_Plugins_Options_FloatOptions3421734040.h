...
struct  FloatOptions_t3421734040 
{
public:
...
public:
	inline static int32_t get_offset_of_snapping_0() { return static_cast<int32_t>(offsetof(FloatOptions_t3421734040, ___snapping_0)); }
...
struct FloatOptions_t3421734040_marshaled_pinvoke
{
	int32_t ___snapping_0;
};
// Native definition for marshalling of: DG.Tweening.Plugins.Options.FloatOptions
struct FloatOptions_t3421734040_marshaled_com
{
	int32_t ___snapping_0;
};
